...
struct LatticeConnectivity <: AbstractConnectivity
    ...
    function LatticeConnectivity(
        ...
        new(qubits_per_row, (nrows, ncols), excluded_positions, sorted_connections)
    end
    ...
    function LatticeConnectivity(
        ...
        ncols = ceil(Int, +(qubits_per_row...) / nrows)
...
with_excluded_positions(
    ...
    LatticeConnectivity(c.qubits_per_row, excluded_positions, c.excluded_connections)
