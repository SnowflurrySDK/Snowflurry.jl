...
function meta(::Type{CircuitJobStatus})
    ProtoBuf.metalock() do
        if !isassigned(__meta_CircuitJobStatus)
            ...
            allflds =
                Pair{Symbol,Union{Type,String}}[:_type=>Int32, :message=>AbstractString]
            meta(
                target,
                CircuitJobStatus,
                allflds,
...
const _CircuitAPI_desc =
    ServiceDescriptor("anyon.thunderhead.qpu.CircuitAPI", 1, _CircuitAPI_methods)
...
mutable struct CircuitAPIStub <: AbstractProtoServiceStub{false}
    ...
    CircuitAPIStub(channel::ProtoRpcChannel) =
        new(ProtoServiceStub(_CircuitAPI_desc, channel))
end # mutable struct CircuitAPIStub

mutable struct CircuitAPIBlockingStub <: AbstractProtoServiceStub{true}
    impl::ProtoServiceBlockingStub
    CircuitAPIBlockingStub(channel::ProtoRpcChannel) =
        new(ProtoServiceBlockingStub(_CircuitAPI_desc, channel))
end # mutable struct CircuitAPIBlockingStub

submitJob(
    stub::CircuitAPIStub,
    controller::ProtoRpcController,
    inp::SubmitJobRequest,
    done::Function,
) = call_method(stub.impl, _CircuitAPI_methods[1], controller, inp, done)
submitJob(
    stub::CircuitAPIBlockingStub,
    controller::ProtoRpcController,
    inp::SubmitJobRequest,
) = call_method(stub.impl, _CircuitAPI_methods[1], controller, inp)

getJobStatus(
    stub::CircuitAPIStub,
    controller::ProtoRpcController,
    inp::JobStatusRequest,
    done::Function,
) = call_method(stub.impl, _CircuitAPI_methods[2], controller, inp, done)
getJobStatus(
    stub::CircuitAPIBlockingStub,
    controller::ProtoRpcController,
    inp::JobStatusRequest,
) = call_method(stub.impl, _CircuitAPI_methods[2], controller, inp)

getJobResult(
    stub::CircuitAPIStub,
    controller::ProtoRpcController,
    inp::JobResultRequest,
    done::Function,
) = call_method(stub.impl, _CircuitAPI_methods[3], controller, inp, done)
getJobResult(
    stub::CircuitAPIBlockingStub,
    controller::ProtoRpcController,
    inp::JobResultRequest,
) = call_method(stub.impl, _CircuitAPI_methods[3], controller, inp)

export CircuitJobStatus_CircuitJobStatusType,
    CircuitJobStatus,
    SubmitJobRequest,
    SubmitJobReply,
    JobStatusRequest,
