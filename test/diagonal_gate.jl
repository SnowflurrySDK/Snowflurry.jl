...
@testset "Diagonal Gate: phase_shift" begin
    ...
    @test phase_gate_operator[2, 1] === ComplexF64(0.0)
    ...
    @test composite_op[1, 2] == ComplexF64(0.0)
    ...
    @test adjoint(phase_gate_operator) ≈
...
@testset "Diagonal Gate: apply_operator to last qubit" begin
    ...
    @test op[1, 1] === ComplexF64(1.0)
    @test op[2, 2] === exp(im * ϕ)
    @test op[2, 1] === ComplexF64(0.0)
