...
failure_tuple = (failed_status, Dict{String,Int}(), 0)
cancellation_tuple = (cancelled_status, Dict{String,Int}(), 0)
invalid_response_tuple = (invalid_status, Dict{String,Int}(), 0)
