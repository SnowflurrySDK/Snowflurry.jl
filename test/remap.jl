...
test_cases = [
    ...
    (
        data_2qubits,
        Dict(1 => 2, 2 => 1),
        Dict{String,Int}("00" => 1, "01" => 300, "10" => 20, "11" => 4000),
    ) # symmetric swaps
    # #
    ...
    (
        data_3qubits,
        Dict(1 => 2, 3 => 3),
        Dict{String,Int}("000" => 21, "001" => 4300, "100" => 650000, "101" => 87000000),
    )
    (
        data_3qubits,
        Dict(2 => 3, 1 => 1),
        Dict{String,Int}("00" => 301, "01" => 4020, "10" => 7050000, "11" => 80600000),
    )
    # # #
    ...
    (
        data_3qubits,
        Dict(1 => 2, 2 => 3),
        Dict{String,Int}("00" => 21, "01" => 4300, "10" => 650000, "11" => 87000000),
    )
    (
        data_3qubits,
        Dict(1 => 3, 2 => 2, 3 => 1),
