...
function post_checker_readout(url::String, user::String, access_token::String, body::String)
    ...
    expected_url = host * "/" * Snowflurry.path_jobs
    expected_access_token = access_token
    expected_json = "{\"name\":\"default\",\"machine_id\":\"http://example.anyonsys.com\",\"shot_count\":100,\"type\":\"circuit\",\"circuit\":{\"operations\":[{\"parameters\":{},\"type\":\"x\",\"qubits\":[2]},{\"bits\":[2],\"type\":\"readout\",\"qubits\":[2]}]}}"
...
function post_checker_last_qubit_Yukon(
    ...
    expected_url = host * "/" * Snowflurry.path_jobs
    expected_access_token = access_token
    expected_json = "{\"name\":\"default\",\"machine_id\":\"http://example.anyonsys.com\",\"shot_count\":100,\"type\":\"circuit\",\"circuit\":{\"operations\":[{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[5]},{\"parameters\":{},\"type\":\"x\",\"qubits\":[5]},{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[5]},{\"bits\":[0],\"type\":\"readout\",\"qubits\":[0]}]}}"
...
function post_checker_last_qubit_Yamaska(
    ...
    expected_url = host * "/" * Snowflurry.path_jobs
    expected_access_token = access_token
    expected_json = "{\"name\":\"default\",\"machine_id\":\"http://example.anyonsys.com\",\"shot_count\":100,\"type\":\"circuit\",\"circuit\":{\"operations\":[{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[11]},{\"parameters\":{},\"type\":\"x\",\"qubits\":[11]},{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[11]},{\"bits\":[0],\"type\":\"readout\",\"qubits\":[0]}]}}"
...
function stubStatusResponse(status::String)::HTTP.Response
    if status == Snowflurry.succeeded_status
        HTTP.Response(
            200,
            [],
            body = "{\"status\":{\"type\":\"$status\"}, \"histogram\":{\"001\":100}}",
        )
    else
        HTTP.Response(
            200,
            [],
            body = "{\"status\":{\"type\":\"$status\"}, \"histogram\":{}}",
        )
    end
end
