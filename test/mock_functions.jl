...
function post_checker_last_qubit_Yukon(url::String,user::String,access_token::String,body::String)
...
function post_checker_toffoli_Yukon(url::String,user::String,access_token::String,body::String)
...
function request_checker(url::String,user::String,access_token::String)
    ...
    if !isnothing(match_obj)
        ...
        myregex=Regex("(.*)(/$(Snowflurry.path_circuits)/)(.*)(/$(Snowflurry.path_results))\$")   
        match_obj=match(myregex,url)
