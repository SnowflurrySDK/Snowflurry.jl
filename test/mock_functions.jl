...
function post_checker_readout(url::String, user::String, access_token::String, body::String)
    ...
    expected_url = host * "/" * Snowflurry.path_circuits
    expected_access_token = access_token
    expected_json = "{\"shot_count\":100,\"circuit\":{\"operations\":[{\"parameters\":{},\"type\":\"x\",\"qubits\":[2]},{\"qubit\":2,\"type\":\"readout\",\"bit\":2}]}}"
...
function post_checker_last_qubit_Yukon(
    ...
    expected_url = host * "/" * Snowflurry.path_circuits
    expected_access_token = access_token
    expected_json = "{\"shot_count\":100,\"circuit\":{\"operations\":[{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[5]},{\"parameters\":{},\"type\":\"x\",\"qubits\":[5]},{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[5]},{\"qubit\":0,\"type\":\"readout\",\"bit\":0}]}}"
...
function post_checker_last_qubit_Yamaska(
    ...
    expected_url = host * "/" * Snowflurry.path_circuits
    expected_access_token = access_token
    expected_json = "{\"shot_count\":100,\"circuit\":{\"operations\":[{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[11]},{\"parameters\":{},\"type\":\"x\",\"qubits\":[11]},{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[11]},{\"qubit\":0,\"type\":\"readout\",\"bit\":0}]}}"
...
function post_checker_transpiled(
    ...
    expected_url = host * "/" * Snowflurry.path_circuits
    expected_access_token = access_token
    expected_json = "{\"shot_count\":100,\"circuit\":{\"operations\":[{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[2]},{\"parameters\":{},\"type\":\"x\",\"qubits\":[2]},{\"parameters\":{},\"type\":\"z_90\",\"qubits\":[2]},{\"parameters\":{},\"type\":\"cz\",\"qubits\":[1,0]},{\"qubit\":2,\"type\":\"readout\",\"bit\":2}]}}"
